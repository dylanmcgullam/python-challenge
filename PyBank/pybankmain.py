...
results_file = os.path.join(".", "Instructions", "PyBank/Resources", "budeget_data_results.text")
...
with open(results_file, "w",) as txtfile:
    ...
    txtfile.write("Total Amount:" + str(total_revenue))
    txtfile.write("Average Change:" + str(mean_change))
    txtfile.write("Greatest Increase in Profits:" + greatest_increase_month + str(high))
    txtfile.write("Greatest Decrease in Profits:" + greatest_decrease_month + str(low))